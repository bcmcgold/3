...
var(
  ...
  Rout1   =NewScalarValue("Rout1","Ohm","SHNO 1 Resistance",func() float64 { return (Rp-Rap)*R[0]/2+(Rp+Rap)/2 }) //Use tableadd(Rout1) to print R, just as E_total
  Rout2   =NewScalarValue("Rout2","Ohm","SHNO 2 Resistance",func() float64 { return (Rp-Rap)*R[1]/2+(Rp+Rap)/2 }) //Note that R[n] is -mx (negative sign)
  Rout3   =NewScalarValue("Rout3","Ohm","SHNO 3 Resistance",func() float64 { return (Rp-Rap)*R[2]/2+(Rp+Rap)/2 })
  Rout4   =NewScalarValue("Rout4","Ohm","SHNO 4 Resistance",func() float64 { return (Rp-Rap)*R[3]/2+(Rp+Rap)/2 })
