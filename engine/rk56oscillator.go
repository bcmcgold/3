...
type RK56oscillator struct {
}

func (rk *RK56oscillator) Step() {
	...
	M.normalize()
	UpdateOutputResistance() // after m is updated, recalculate resistance and coupling current
	torqueFn(k2)
